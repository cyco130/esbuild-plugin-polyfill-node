...
export interface PolyfillNodeOptions {
	...
	polyfills?: {
		_stream_duplex?: boolean | string | "empty";
		_stream_passthrough?: boolean | string | "empty";
		_stream_readable?: boolean | string | "empty";
		_stream_transform?: boolean | string | "empty";
		_stream_writable?: boolean | string | "empty";
		assert?: boolean | string | "empty";
		"assert/strict"?: boolean | string | "empty";
		async_hooks?: boolean | string | "empty";
		buffer?: boolean | string | "empty";
		child_process?: boolean | string | "empty";
		cluster?: boolean | string | "empty";
		console?: boolean | string  | string| "empty";
		constants?: boolean | string | "empty";
		crypto?: boolean | string | "empty";
		dgram?: boolean | string | "empty";
		diagnostics_channel?: boolean | string | "empty";
		dns?: boolean | string | "empty";
		domain?: boolean | string | "empty";
		events?: boolean | string | "empty";
		fs?: boolean | string | "empty";
		"fs/promises"?: boolean | string | "empty";
		http?: boolean | string | "empty";
		http2?: boolean | string | "empty";
		https?: boolean | string | "empty";
		module?: boolean | string | "empty";
		net?: boolean | string | "empty";
		os?: boolean | string | "empty";
		path?: boolean | string | "empty";
		perf_hooks?: boolean | string | "empty";
		process?: boolean | string | "empty";
		punycode?: boolean | string | "empty";
		querystring?: boolean | string | "empty";
		readline?: boolean | string | "empty";
		repl?: boolean | string | "empty";
		stream?: boolean | string | "empty";
		string_decoder?: boolean | string | "empty";
		sys?: boolean | string | "empty";
		timers?: boolean | string | "empty";
		"timers/promises"?: boolean | string | "empty";
		tls?: boolean | string | "empty";
		tty?: boolean | string | "empty";
		url?: boolean | string | "empty";
		util?: boolean | string | "empty";
		v8?: boolean | string | "empty";
		vm?: boolean | string | "empty";
		wasi?: boolean | string | "empty";
		worker_threads?: boolean | string | "empty";
		zlib?: boolean | string | "empty";
	};
}
	...
	return {
		...
		async setup(build) {
			...
			build.onResolve({ filter }, async ({ path }) => {
				...
				} else if (typeof polyfill === "string") {
					return { path: polyfill };
				}
